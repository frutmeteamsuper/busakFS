  ...
  if (typeof Chart !== 'undefined') {
    ...
    if ($("#barChart1").length) {
      ...
      var barData1 = {
        ...
        datasets: [{
          ...
          backgroundColor: ["#fcb2bf", "#629FFF", "#6BA4FE", "#74AAFF", "#7AAEFF", '#85B4FF'],
    ...
    if ($("#pieChart1").length) {
      ...
      var pieData1 = {
        ...
        datasets: [{
          ...
          backgroundColor: ["#fcb2bf", "#cf56a1", "#8b2f97", "#ffcc29", "#f37070"],
          hoverBackgroundColor: ["#fcb2bf", "#cf56a1", "#8b2f97", "#ffcc29", "#f37070"],
          borderWidth: 0
        }]
      };
    ...
    if ($("#donutChart1").length) {
      ...
      var data1 = {
        ...
        datasets: [{
          data: [300, 50, 100, 30, 70],
          backgroundColor: ["#fcb2bf", "#cf56a1", "#8b2f97", "#ffcc29", "#561f55"],
          hoverBackgroundColor: ["#fcb2bf", "#cf56a1", "#8b2f97", "#ffcc29", "#561f55"],
          borderWidth: 6,
